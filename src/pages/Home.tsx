...
const Home = () => {
  const features = [
    ...
    },
    {
      icon: Lock,
      title: "Data Security",
      description: "Bank-grade encryption ensures your family's information stays private.",
    },
    {
      icon: Eye,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <div className="inline-block px-4 py-2 bg-primary/10 rounded-full">
                <p className="text-sm font-medium text-secondary">Powered by Jendie Automobiles Ltd.</p>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-foreground leading-tight">
                Keep Your Child Safe,{" "}
                <span className="text-gradient-blue">Every Step</span> of the Way
              </h1>
              <p className="text-lg text-muted-foreground max-w-xl">
                Real-time school transport tracking that gives parents peace of mind and schools complete transparency.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button asChild variant="hero" size="xl">
                  <Link to="/auth">Track My Child</Link>
                </Button>
                <Button asChild variant="outline" size="xl" className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive safety features designed with your child's well-being in mind
            </p>
          </div>
